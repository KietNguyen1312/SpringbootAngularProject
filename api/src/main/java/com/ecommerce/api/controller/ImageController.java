...
import com.ecommerce.api.service.image.IImageService;
...
public class ImageController {
    ...
    public ResponseEntity<ApiResponse> deleteImage(@PathVariable Long id) {
        ...
        return ResponseEntity.status(INTERNAL_SERVER_ERROR).body(new ApiResponse("Image already deleted!", INTERNAL_SERVER_ERROR));
    }
}
